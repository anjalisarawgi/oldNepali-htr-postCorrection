...
print(f"Total GT characters   :", df["gt_len"].sum())
print(f"Total Pred characters : {df['pred_len'].sum()}")
...
print(f"Total errors: {total_edit_distance}") ####????
...
## whats the difference between total errors and total edit distance?